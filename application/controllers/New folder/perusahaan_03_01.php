...
// 5.11 FUNGSI CALLBACK_SERTIFIKASI
    ...
    public function callback_sertifikasi(){
		...
		$output .= 'var clone5 = $("#btn_add").clone(); clone5.attr({id: "btn_del"+counter, type:"button", goto:"cloneObject"+counter, name:"btn_del", class:"input-del"}).click(function(){$delrow = $(this).attr("goto"); $("#"+ $delrow).remove();}); ';
