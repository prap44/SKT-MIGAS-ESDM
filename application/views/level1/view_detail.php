		...
		<div class="columnfull">
			...
			<div class="form-group grup-tombol-detail-kanan">
			  <div class="col-lg-10 col-lg-offset-2">
				<a href="<?php echo site_url('perusahaan/revisi_pengajuan/'.$this->uri->segment(4)); ?>" target="_blank"><button class="btn btn-primary detail" type="button">Perbaiki </button></a>
			  </div>
			</div>
