...
<div class="twitter-bootstrap crud-form">
	...
	<div id="main-table-box span12">
		<?php
		echo form_open( $insert_url, 'method="post" id="crudForm" class="form-horizontal" role="form" autocomplete="off" enctype="multipart/form-data"');
			foreach($fields as $field)
			{
				?>
				<div class="form-group" id="<?php echo $field->field_name; ?>_field_box">
					<label class="col-sm-2 control-label" id="<?php echo $field->field_name; ?>_display_as_box">
			...
			<input type="button" value="<?php echo $this->l('form_save'); ?>"  class="btn btn-small btn-primary submit-form"/>
