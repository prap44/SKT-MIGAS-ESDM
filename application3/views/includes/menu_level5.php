		...
		$( document ).ready(function() {	
			var pathname = window.location.pathname;
			 ...
			 else if(pathname[3] == 'daftar_pengajuan_skt' || pathname[3] == 'pengajuan_skt_diterima'){
				$('#pengajuan_skt').addClass('active');	
				$('#judul').text('*Daftar Pengajuan SKT');	 
			 }
			 ...
			 else if(pathname[3] == 'detail_perusahaan' && pathname[4] == 'pengajuan_skp'){
				$('#pengajuan_skp').addClass('active');		 
			 }
			 
			 else if(pathname[3] == 'daftar_pengajuan_skp' || pathname[3] == 'pengajuan_skp_diterima'){
				$('#pengajuan_skp').addClass('active');	
				$('#judul').text('*Pengajuan SK Penunjukkan');	 
			 }
			 
			 else if(pathname[4] == 'revisi_skt' || pathname[4] == 'revisi_skp' || pathname[3] == 'daftar_revisi_kasie' || pathname[3] == 'pengajuan_revisi_diterima'){
				$('#daftar_revisi').addClass('active');	
				$('#judul').text('*Revisi Pengajuan SKT');	 
			 }	
			 ...
			 else if(pathname[3] == 'daftar_pengajuan_skt_admin_naik' || pathname[3] == 'pengajuan_skt_diterima_naik' || pathname[3] == 'revisi_pengajuan_skt' && pathname[4] == 'pengajuan_skt' || pathname[3] == 'no_dokumen_skt'){
				$('#pengajuan_naik').addClass('active');	
				$('#judul').text('*Pengajuan Sudah Dievaluasi Evaluator');	 	 
			 } 
				
			 else if(pathname[4] == 'pengajuan_skt_admin_naik' || pathname[4] == 'pengajuan_skp_admin_naik'){
				$('#pengajuan_naik').addClass('active');	 	 
			 } 
				
			 else if(pathname[3] == 'daftar_pengajuan_skp_admin_naik' || pathname[3] == 'pengajuan_skp_diterima_naik' || pathname[3] == 'revisi_pengajuan_skt' && pathname[4] == 'pengajuan_skp' || pathname[3] == 'no_dokumen_skp'){
				$('#pengajuan_naik_skp').addClass('active');	
				$('#judul').text('*Pengajuan Sudah Dievaluasi Evaluator');	 	 
			 } 
			 ...
			 else if(pathname[3] == 'detail_perusahaan' && pathname[5] == 'pengajuan_skp'){
				$('#pengajuan_skp').addClass('active');	
				$('#judul').text('Detil Perusahaan Pemohon SK Penunjukkan');	 
			 }
			 ...
			 else if(pathname[3] == 'laporan_berkala_kasie'){
		...
		<div class="dashboardmenu">
			<ul class="nav nav-tabs" role="tablist">
			  ...
			  <li role="presentation" id="daftar_revisi"><a href="<?php echo base_url() ?>all_admin/daftar_revisi_kasie" role="tab" data-toggle="tab"><img src="<?php echo base_url('assets/images') ?>/icon/pelaporan-icon.png" class="tab-icon"><br/>Daftar Revisi</a></li>
			  ...
			  <li role="presentation" id="pelaporan"><a href="<?php echo base_url() ?>all_admin/laporan_berkala_kasie" role="tab" data-toggle="tab"><img src="<?php echo base_url('assets/images') ?>/icon/lap_berkala.png" class="tab-icon"><br/>Pelaporan Berkala</a></li>
