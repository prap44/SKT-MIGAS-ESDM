		...
		$( document ).ready(function() {
			var pathname = window.location.pathname;
			 ...
			 if(pathname[3] == 'dashboard' || pathname[3] == 'login'){
			 ...
			 else if(pathname[3] == 'daftar_pengajuan_skt_admin_naik' || pathname[3] == 'pengajuan_skt_diterima_naik' || pathname[3] == 'detail_evaluasi'){
				$('#pengajuan_naik').addClass('active');	
				$('#judul').text('*Pengajuan Sudah Dievaluasi Kasubdit');	 
			 }	
			 
			 else if(pathname[3] == 'daftar_pengajuan_skp_admin_naik' || pathname[3] == 'pengajuan_skp_diterima_naik' || pathname[3] == 'detail_evaluasi'){
				...
				$('#judul').text('*Pengajuan SKT Masuk');	 
			 }	
