...
?>			
		...
		<?php $this->load->view('includes/content/all_details') ?>
			<div class="form-group grup-tombol-detail-kanan">
			  <div class="col-lg-10 col-lg-offset-2">
				<a class="btn btn-warning" href="<?=site_url('all_admin/pengajuan_skt_diterima_naik/add/'.$this->uri->segment(4))?>">Belum Lengkap</a>
				<a class="btn btn-success" href="<?=site_url('all_admin/konsep_dokumen_skt/pengajuan_skt/'.$this->uri->segment(4))?>">Lengkap</a>
			  </div>
			</div>
