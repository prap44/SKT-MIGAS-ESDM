		...
		<div class="columnfull">
			...
			<div class="form-group grup-tombol-detail-kanan">
			  <div class="col-lg-10 col-lg-offset-2">
				<a class="btn btn-success" href="<?=site_url('all_admin/daftar_'.$param.'_admin_naik'); ?>">Kembali</a>
				...
				<?php if($this->session->userdata('level')==5){ 
						...
						<?php }elseif($this->uri->segment(3)=='revisi_skt'){?>
							<a class="btn btn-danger" href="<?=site_url('all_admin/detail_perusahaan/'.$param.'_admin_naik/'.$this->uri->segment(4))?>" >Revisi</a>
						<?php }elseif($this->uri->segment(3)!='revisi_skt' && $this->uri->segment(3)!='revisi_skp'){ ?>
							<a class="btn btn-danger" href="<?=site_url('admin/revisi_pengajuan_skt/'.$param.'/'.$this->uri->segment(4))?>" >Revisi Perusahaan</a>
							<a class="btn btn-warning" href="<?=site_url('all_admin/'.$param.'_diterima/add/'.$this->uri->segment(4))?>">Revisi Evaluator</a>
				<?php } 
				}?>
