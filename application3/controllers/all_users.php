            ...
            if ($level == 1) {
                ...
                if ($status) {
                    if ($status->status_progress == 3 || $status->status_progress == 10) {
                        $notif = '<h3>*Anda mendapatkan catatan revisi dari Admin! &nbsp <a href="' . base_url('all_admin/detail_perusahaan/pengajuan_skt/' . $status->id_permohonan) . '" target="_blank"><button class="btn btn-sm btn-primary detail" type="button">Lihat Catatan</button></a></h3>';
