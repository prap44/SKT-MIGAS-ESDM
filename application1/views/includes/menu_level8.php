		...
		<div class="dashboardmenu">
			<ul class="nav nav-tabs" role="tablist">
			  ...
			  <li role="presentation" id="kotak_pesan"><a href="<?php echo base_url() ?>all_admin/kotak_pesan" role="tab" data-toggle="tab"><img src="<?php echo base_url('assets/images') ?>/icon/mail-icon.png" class="tab-icon"><br/>Kotak<br/>Pesan</a></li>
