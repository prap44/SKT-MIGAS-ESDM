...
<body>
	...
	<div class="header">
		<div class="mainhead">
			...
			<div class="sub-nav" style="background-color: #fff; border-top:5px solid #333;">
				<div id="sub-navigation">
				    <div class="form-group tombols-kanan">
						<a href="<?php echo site_url('perusahaan/laporan_berkala'); ?>"><button class="btn btn-primary detail" type="button">Kembali </button></a>
						<a href="javascript:window.print()"><button class="btn btn-success detail" type="button">Print Data</button></a>
						<a href="<?php echo base_url('perusahaan/proses_laporan/proses/'.$this->session->userdata('id_permohonan')); ?>"><button class="btn btn-warning detail" type="button">Upload Laporan </button></a>
					</div>
				</div>
			</div>
		</div>	
	...
	<div class="content">
		<div class="columnfull">
			<div class="borderbottomdotted" style="margin-bottom:0!important">
				...
				<table class="table table-bordered table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td><?= anchor('assets/uploads/files/file_keanggotaan_asosiasi/'.$asosiasi->file_keanggotaan_asosiasi, 'Dokumen') ?></td>
						</tr><?php	$ada = 'ada';
								}elseif($status_pemakaian == ''){
								   unset( $temp[$key] );
								}
