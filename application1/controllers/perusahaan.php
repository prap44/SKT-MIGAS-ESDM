...
public function data_umum()
{
  ...
  $c->fields('id_perusahaan', 'jenis_dokumen', 'penerbit', 'tanggal_terbit', 'akhir_masa_berlaku', 'file_dokumen');
  ...
  /* $c->callback_column('file_dokumen', function ($value, $row){
    return '<input type="text" value="'.$value.'" name="file_dokumen"> <span style="color:red; font-size:10px">*) File maksimal 200Kb, selain Akta Perusahaan</span>';
}); */
  //$c->field_type('skrip', 'hidden');
	...
	/*   $c->callback_field('skrip', function ($value, $row){
		...
		$("#skrip_field_box").remove();$( ".ui-datepicker-year" ).datepicker({ yearRange: "1910:2010" });</script>'; 
		return $output;
  } */
        // unset columns
...
public function data_khusus()
{
 ...
 if($ada != NULL){
   return '<a class="link-pilih" href="'.base_url().'perusahaan/ganti/data_pemohon/data_khusus/'.$row->id_dokumen.'"><img class="btn-ganti">Ubah</a>';
 }else{
   return '<a class="link-pilih" href="'.base_url().'perusahaan/pilih/data_pemohon/data_khusus/'.$row->id_dokumen.'"><img class="btn-pilih">Pilih</a>';
 }	
});		
...
public function keanggotaan_asosiasi()
{
 ...
 if($ada != NULL){
   return '<a class="link-pilih" href="'.base_url().'perusahaan/ganti/keanggotaan_asosiasi/keanggotaan_asosiasi/'.$row->id_keanggotaan.'"><img class="btn-ganti">Ubah</a>';
 }else{
   return '<a class="link-pilih" href="'.base_url().'perusahaan/pilih/keanggotaan_asosiasi/keanggotaan_asosiasi/'.$row->id_keanggotaan.'"><img class="btn-pilih">Pilih</a>';
 }	
});	
...
public function tenaga_kerja(){
 ...
 if($ada != NULL){
   $output = '<a class="link-pilih" href="'.base_url().'perusahaan/ganti/data_tenaga_kerja/tenaga_kerja/'.$row->id_tenaga_kerja.'"><img class="btn-ganti">Ubah</a>';
 }else{
   $output = '<a class="link-pilih" href="'.base_url().'perusahaan/pilih/data_tenaga_kerja/tenaga_kerja/'.$row->id_tenaga_kerja.'"><img class="btn-pilih">Pilih</a>';
 }	
 return $output;
});
...
// 5.13 FUNGSI PELATIHAN_TENAGA_KERJA_INTERNAL
      ...
      public function pelatihan_tenaga_kerja_internal(){
       ...
       if($ada != NULL){
         return '<a class="link-pilih" href="'.base_url().'perusahaan/ganti/pelatihan_tenaga_kerja/pelatihan_tenaga_kerja_internal/'.$row->id_pelatihan.'"><img class="btn-ganti">Ubah</a>';
       }else{
         return '<a class="link-pilih" href="'.base_url().'perusahaan/pilih/pelatihan_tenaga_kerja/pelatihan_tenaga_kerja_internal/'.$row->id_pelatihan.'"><img class="btn-pilih">Pilih</a>';
       }	
     });
...
public function pelatihan_tenaga_kerja_eksternal()
{
 ...
 if($ada != NULL){
   return '<a class="link-pilih" href="'.base_url().'perusahaan/ganti/pelatihan_tenaga_kerja/pelatihan_tenaga_kerja_eksternal/'.$row->id_pelatihan.'"><img class="btn-ganti">Ubah</a>';
 }else{
   return '<a class="link-pilih" href="'.base_url().'perusahaan/pilih/pelatihan_tenaga_kerja/pelatihan_tenaga_kerja_eksternal/'.$row->id_pelatihan.'"><img class="btn-pilih">Pilih</a>';
 }	
});
...
public function peralatan_utama(){
 ...
 if($ada != NULL){
   return '<a class="link-pilih" href="'.base_url().'perusahaan/ganti/peralatan/peralatan/'.$row->id_sarana.'"><img class="btn-ganti">Ubah</a>';
 }else{
   return '<a class="link-pilih" href="'.base_url().'perusahaan/pilih/peralatan/peralatan/'.$row->id_sarana.'"><img class="btn-pilih">Pilih</a>';
 }	
});
...
// 5.17 FUNGSI NILAI_INVESTASI
    ...
    public function callback_mata_uang($value='', $primary_key  = null)
    {
      ...
      <option class="opt-center" value="Rupiah">Rupiah</option>
...
// 5.18 FUNGSI PENGALAMAN_KERJA
  ...
  function pengalaman_kerja(){
   ...
   if($ada != NULL){
     return '<a class="link-pilih" href="'.base_url().'perusahaan/ganti/pengalaman_kerja/daftar_pekerjaan/'.$row->id_daftar_pekerjaan.'"><img class="btn-ganti">Ubah</a>';
   }else{
     return '<a class="link-pilih" href="'.base_url().'perusahaan/pilih/pengalaman_kerja/daftar_pekerjaan/'.$row->id_daftar_pekerjaan.'"><img class="btn-pilih">Pilih</a>';
   }	
 });
...
// 5.19 FUNGSI SOP
  ...
  public function sop(){
   ...
   if($ada != NULL){
     return '<a class="link-pilih" href="'.base_url().'perusahaan/ganti/sop/sop/'.$row->id_sop.'"><img class="btn-ganti">Ubah</a>';
   }else{
     return '<a class="link-pilih" href="'.base_url().'perusahaan/pilih/sop/sop/'.$row->id_sop.'"><img class="btn-pilih">Pilih</a>';
   }	
 });
...
$nilai = 0;
if($nilai_investasi != NULL){						
 $i=1; foreach($nilai_investasi as $invest){
  $nilai = $nilai + $invest->persentase;				
}
}
...
if($nilai != 0){
 if($nilai < 100){
  $niv = 'Nilai Investasi perusahaan Anda belum mencapai angka 100%';
}elseif($nilai > 100){
  $niv = 'Nilai Investasi perusahaan Anda melebihi angka 100%';
}
}
